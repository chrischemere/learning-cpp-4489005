...
int main(){
    ...
    std::cout << "At index 0 we have " << cattle[0].get_name() << std::endl;
    std::cout << "At index 1 we have " << cattle[1].get_name() << std::endl;
    std::cout << "At index 2 we have " << cattle[2].get_name() << std::endl;
    std::cout << "At index 3 we have " << cattle[3].get_name() << std::endl;
